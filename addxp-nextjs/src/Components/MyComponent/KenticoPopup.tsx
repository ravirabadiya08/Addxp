...
const KenticoPopup: React.FC<MyComponentProps> = ({ children }) => {
            ...
            message: {
              ...
              html: `<html>
                      ...
                      <body>
                          <p>Hello Team,
                          <br>
                          We have got the following details from Kentico Pop up  
                          <br></p>
  ...
  return (
    <div>
      {showAlert && (
        <div className="popup kentico-popup popup-wrapper">
