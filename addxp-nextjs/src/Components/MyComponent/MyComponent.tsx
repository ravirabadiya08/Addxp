            ...
            message: {
              ...
              html: `<html>
                      ...
                      <body>
                          <p>Hello Team,
                          <br>
                          We have got the following details from Pop up Inquiry
                          <br></p>
      ...
      {showAlert && (
        <div className="popup">
          <div className="popup-content">
            ...
            <h2 className="pop-up-title">Get a Free CMS Audit</h2>
            <p className="pop-up-subtitle">Request a free performance audit to optimize your current CMS system.</p>
