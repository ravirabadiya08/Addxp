...
const UmbracoPopup: React.FC<MyComponentProps> = ({ children }) => {
            ...
            message: {
              ...
              html: `<html>
                      ...
                      <body>
                          <p>Hello Team,
                          <br>
                          We have got the following details from Umbraco Pop up  
                          <br></p>
  ...
  return (
    <div>
      {showAlert && (
        <div className="popup umbraco-popup popup-wrapper">
          <div className="popup-content">
            <span className="close" onClick={handleAlertClose}>
              &times;
            </span>
            <h2 className="pop-up-title">Wait! Before You Go, How About a Free Umbraco Site Audit?</h2>
