...
export default async function Page() {
  try {
    const [
      ...
      getServerSideProps(SEO("commerceExperience")),
      getServerSideProps(VIDEOBANNER("commerceExperience")),
      getServerSideProps(SERVICEEXPERIENCEDETAILS("commerceExperience")),
      getServerSideProps(CTA_QUERY("commerceExperience")),
      getServerSideProps(SERVICE_PROCESS("commerceExperience")),
      getServerSideProps(CONTACT_FORM_TITLE_QUERY("commerceExperience")),
      getServerSideProps(FORM_TITLE_QUERY("commerceExperience")),
      getServerSideProps(VISUALUX("commerceExperience")),
      getServerSideProps(STRAPI_RELATED_SERVICES("commerceExperience")),
      getServerSideProps(SERVICE_EXP_QUERY("commerceExperience")),
      getServerSideProps(LATEST_NEWS("commerceExperience")),
      getServerSideProps(FAQ("commerceExperience")),
      getServerSideProps(VERTICAL_SLIDER("commerceExperience")),
    ]);

    const extract = (res: any) => res?.data?.commerceExperience || null;
